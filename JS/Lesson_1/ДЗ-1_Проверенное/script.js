...
// Результат решения этой задачи потенциально может понадобится ге-нибудь ещё, поэтому его целесообразнее получить в отдельной инструкции кода и сохранить в отдельную сущность, а не выполнять это решение в строке с выводом. Также, такие строки со внутренними решениями становятся менее наглядны и читабельны, чем решения, выполняемые в отдельных инструкциях.
...
// Здесь также результат целесообразнее получить в отдельной инструкции кода
...
// Разберите также вот это решение 10 задания
let number = 111;
alert( (number % 2 == 0 && 'Число чётное') || (number % 2 != 0 && 'Число нечётное') );
