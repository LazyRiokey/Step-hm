...
/* USE University
INSERT INTO Students([First name], [Last name], [Phone number])
VALUES(N'Кирилл', N'Иванов', 89546784287); */
...
/* USE University
UPDATE Table_1
SET [First name] = N'Ольга', [Last name] = N'Иванова'
WHERE id = 5; */
...
/* USE University
INSERT INTO Table_2([First name], [Last name], [Phone number])
VALUES
(N'Иван', N'Иванов', 85623147895),
(N'Эдуард', N'Эдуардов', 85687347554); */
